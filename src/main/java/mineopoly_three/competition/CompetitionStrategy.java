...
public class CompetitionStrategy implements MinePlayerStrategy {
    ...
    private java.util.List<Point> marketTiles = new ArrayList<>();
    private java.util.List<Point> chargeTiles = new ArrayList<>();
    ...
    private TurnAction findResource(PlayerBoardView boardView, Point currentLocation) {
        java.util.List<Point> resourceTiles = getResourceLocations(boardView); //gets all resource points
    ...
    private boolean isOnMinedItem(PlayerBoardView boardView, Point currentLocation) {
        if (boardView.getItemsOnGround().get(currentLocation) != null) {
            java.util.List<InventoryItem> items = boardView.getItemsOnGround().get(currentLocation);
     ...
     */
    private java.util.List<Point> getResourceLocations(PlayerBoardView boardView) {
